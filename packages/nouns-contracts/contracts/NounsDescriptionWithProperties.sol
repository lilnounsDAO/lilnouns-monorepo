...
contract NounsDescriptorWithProperties is Ownable, INounsDescriptorWithProperties {
    ...
    function dataURI(uint256 tokenId, INounsSeeder.Seed memory seed) public view returns (string memory) {
        ...
        string memory name = string(abi.encodePacked('LilNoun ', nounId));
        string memory description = string(abi.encodePacked('LilNoun ', nounId, ' is a member of the LilNouns DAO'));
    ...
    function genericDataURI(
        ...
        return NFTDescriptorProperties.constructTokenURI(params, address(previousDescriptor));
    }
    ...
    function generateSVGImage(INounsSeeder.Seed memory seed) external view returns (string memory) {
        ...
        return NFTDescriptorProperties.generateSVGImage(params, 4, address(previousDescriptor));
    }
