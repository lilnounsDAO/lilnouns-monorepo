...
export { default as LilVRGDAABI } from '../abi/contracts/LilVRGDA.sol/LilVRGDA.json';
export { default as NounsSeederV2ABI } from '../abi/contracts/NounsSeederV2.sol/NounsSeederV2.json';
