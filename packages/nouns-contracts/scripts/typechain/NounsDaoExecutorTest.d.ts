...
interface NounsDaoExecutorTestInterface extends ethers.utils.Interface {
  functions: {
...
export class NounsDaoExecutorTest extends Contract {
  ...
  interface: NounsDaoExecutorTestInterface;
