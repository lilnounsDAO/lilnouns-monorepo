...
interface NounsDaoExecutorHarnessInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "harnessSetPendingAdmin",
    values: [string]
  ): string;
  encodeFunctionData(
...
export class NounsDaoExecutorHarness extends Contract {
  ...
  functions: {
    ...
    "harnessSetPendingAdmin(address)"(
      pendingAdmin_: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
