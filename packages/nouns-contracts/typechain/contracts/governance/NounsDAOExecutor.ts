...
export interface NounsDAOExecutorInterface extends utils.Interface {
  functions: {
...
export interface NounsDAOExecutor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NounsDAOExecutorInterface;
