...
export interface NounsDAOProxyV2Interface extends utils.Interface {
  functions: {
...
export interface NounsDAOProxyV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NounsDAOProxyV2Interface;
