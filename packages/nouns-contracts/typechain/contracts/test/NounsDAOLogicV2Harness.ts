...
export interface NounsDAOLogicV2HarnessInterface extends utils.Interface {
  functions: {
...
export interface NounsDAOLogicV2Harness extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NounsDAOLogicV2HarnessInterface;
