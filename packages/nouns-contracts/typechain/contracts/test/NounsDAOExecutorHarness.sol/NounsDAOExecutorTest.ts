...
export interface NounsDAOExecutorTestInterface extends utils.Interface {
  functions: {
...
export interface NounsDAOExecutorTest extends BaseContract {
  ...
  functions: {
    ...
    harnessAcceptAdmin(
      administered: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
