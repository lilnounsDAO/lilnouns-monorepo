...
export interface NounsAuctionHouseProxyAdminInterface extends utils.Interface {
  functions: {
...
export interface NounsAuctionHouseProxyAdmin extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NounsAuctionHouseProxyAdminInterface;
